...
<head>
    ...
    <title>@section('title') Inventaire</title>
    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li><a href="{{ url()->route('home') }}">Scanner</a></li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{ url()->route('article_liste') }}">Liste</a></li>
                        <li><a href="{{ url()->route('article_create') }}">Créer</a></li>
                    </ul>
                </li>
            </ul>
        </div><!--/.nav-collapse -->
